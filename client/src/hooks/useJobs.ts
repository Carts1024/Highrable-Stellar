...
const mockJobs: Job[] = [
  {
    ...
    description: 'Build a comprehensive DeFi dashboard with real-time data visualization, wallet integration, and responsive design.',
    budget: 2500,
    deadline: '2025-02-15',
  ...
  },
  {
    ...
    description: 'Comprehensive security audit for NFT marketplace smart contracts including gas optimization.',
    budget: 5000,
    deadline: '2025-02-20',
...
export const useJobs = () => {
  ...
  const applyToJob = async (jobId: string, application: Omit<Application, 'id' | 'submittedAt' | 'status'>) => {
