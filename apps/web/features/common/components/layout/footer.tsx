...
import {
  ...
  type THighrableV2FooterSocialLink,
...
const SOCIAL_LINKS = [
  {
    label: "Facebook",
    href: "https://facebook.com/highrable",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/highrable.work",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true">
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/highrable",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true">
...
] satisfies readonly THighrableV2FooterSocialLink[];
...
/** Renders the shared Highrable marketing footer with app-specific links, assets, and social media. */
